...
<head>
    ...
    $name = "Maia";
    $comentsQuantity = 1000;

    $Testmonials = ['Emily', 'Jony'];
    ?>
</head>
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am <?php echo $name; ?> !</span>
            </h1>
                    ...
                    <a href="#" class="portfolio-card">
                        ...
                        <span class="portfolio-card-overlay">
                            <span class="portfolio-card-caption">
                                <h4>Web Designing</h5>
                                    <p class="font-weight-normal"> <?php echo $portfolioCategory; ?> </p>
                            </span>
                        </span>
                    </a>
                </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-card-body">
                            <p class="testimonial-card-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing
                                ...
                                adipisci nihil.</p>
                            <h6 class="testimonial-card-title"><?php echo $Testmonials [0]; ?> </h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-card-body">
                            <p class="testimonial-card-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit. Eaque doloribus autem aperiam earum nostrum omnis blanditiis corporis perspiciatis
                                adipisci nihil.</p>
                            <h6 class="testimonial-card-title"><?php echo $Testmonials [1]; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="blog-card-body">
                    <h5 class="blog-card-title">Consectetur adipisicing elit</h6>
                        ...
                        <p class="blog-card-caption">
                            <a href="#">By:<?php echo $name; ?> </a>
                            <a href="#"><i class="ti-heart text-danger"></i> 234</a>
                            <a href="#"><i class="ti-comment"></i> <?php echo $comentsQuantity; ?></a>
                        </p>
